...
urlpatterns = [
    ...
    path('template-polygon_new', template_polygon_new, name='template_polygon_new'),
    ...
    path('template-binance-new', template_binance_new, name='template_binance_new'),
    path('template-polygon-new/delete/<int:profile_id>/', delete_template_polygon_new, name='delete_template_polygon_new'),
    path('edit-template-polygon-new/<int:profile_id>/', edit_template_polygon_new_view, name='edit_template_polygon_new'),
    ...
    path('template-binance-new/delete/<int:profile_id>/', delete_template_binance_new, name='delete_template_binance_new'),
    path('edit-template-binance-new/<int:profile_id>/', edit_template_binance_new_view, name='edit_template_binance_new'),    
]
